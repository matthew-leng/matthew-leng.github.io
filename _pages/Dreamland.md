...
<div style="display: grid; grid-template-columns: 1fr; gap: 20px; margin: 0 auto;">
  <figure style="display: flex; flex-direction: column; gap: 8px;">
    ...
    <div class="dots" data-player="videoPlayer1">
      <span class="dot active" data-src="video1a.mp4">●</span>
      <span class="dot" data-src="video1b.mp4">●</span>
      <span class="dot" data-src="video1c.mp4">●</span>
    </div>
  ...
  <figure style="display: flex; flex-direction: column; gap: 8px;">
    <video id="videoPlayer2" controls>
      <source src="video2a.mp4" type="video/mp4">
      Your browser does not support the video tag.
    </video>
    <div class="dots" data-player="videoPlayer2">
      <span class="dot active" data-src="video2a.mp4">●</span>
      <span class="dot" data-src="video2b.mp4">●</span>
      <span class="dot" data-src="video2c.mp4">●</span>
    </div>
    <figcaption style="text-align: center; font-size: 18px;">
        High-Level Scenes
    </figcaption>
